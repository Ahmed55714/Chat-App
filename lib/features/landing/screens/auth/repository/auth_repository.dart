...
import 'package:chat/common/repositories/common_firebase_storge_repositories.dart';
import 'package:chat/common/utils/utils.dart';
import 'package:chat/features/landing/screens/auth/screens/otp_screen.dart';
...
class AuthRepository {
  ...
  void saveUserDataToFirebase({
    ...
    try {
      ...
      if (profilePic != null) {
        photoUrl = await ref
            .read(CommonFirebasesStoragePerositoryProvider)
            .storeFileToFirebase(
              'profilePic/$uid',
              profilePic,
            );
