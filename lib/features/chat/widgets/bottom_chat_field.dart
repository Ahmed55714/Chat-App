...
class _BottomChatFieldState extends ConsumerState<BottomChatField> {
  ...
  void openAudio() async {
    ...
    if (status != PermissionStatus.granted) {
      throw RecordingPermissionException('Mic rermission not allowed!');
    }
  ...
  void hideKeyboard() => focuseNode.unfocus();
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        isShowMessageReply ? const MesageReplyPreview() : const SizedBox(),
        Row(
          children: [
            Expanded(
              child: TextFormField(
                ...
                onChanged: (val) {
                  if (val.isNotEmpty) {
                    setState(() {
                      isShowSendBotton = true;
                    });
                  } else {
                    setState(() {
                      isShowSendBotton = false;
                    });
                  }
                },
